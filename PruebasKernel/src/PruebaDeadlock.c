...
//	pthread_create(&carpincho1, NULL, carpincho1_func, config);
//    sleep(1);
//	pthread_create(&carpincho2, NULL, carpincho2_func, config);
//    sleep(1);
//	pthread_create(&carpincho3, NULL, carpincho3_func, config);
//    sleep(1);
//	pthread_create(&carpincho4, NULL, carpincho4_func, config);
//    sleep(1);
//	pthread_create(&carpincho5, NULL, carpincho5_func, config);
//	sleep(1);
//	pthread_create(&carpincho6, NULL, carpincho6_func, config);
//	sleep(1);
//
//    mate_close(&instance);
//
