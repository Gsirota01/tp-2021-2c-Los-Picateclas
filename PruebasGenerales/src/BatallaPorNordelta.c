...
void* carpincho5_func();
void* carpincho6_func();
void* carpincho7_func();
void* carpincho8_func();
...
int main() {
	...
	pthread_create(&carpincho5, NULL, carpincho5_func, NULL);
	pthread_create(&carpincho6, NULL, carpincho6_func, NULL);
	pthread_create(&carpincho7, NULL, carpincho7_func, NULL);
	pthread_create(&carpincho8, NULL, carpincho8_func, NULL);
...
void* carpincho1_func() {
	...
	char* config = "/home/utnso/tp-2021-2c-Los-Picateclas/PruebasGenerales/libreria.config";
